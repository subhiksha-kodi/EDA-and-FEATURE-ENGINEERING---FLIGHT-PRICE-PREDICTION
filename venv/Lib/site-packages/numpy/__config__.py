...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "include directory": r"D:/AI WORKSHOP/13.08.2025 - PROJECT 2/venv/Library/include",
                "lib directory": r"D:/AI WORKSHOP/13.08.2025 - PROJECT 2/venv/Library/lib",
                "openblas configuration": r"unknown",
                "pc file directory": r"C:\b\abs_958d_utj4g\croot\numpy_and_numpy_base_1750883811830\_h_env\Library\lib\pkgconfig",
            },
            "lapack": {
                "name": "mkl-sdl",
                "found": bool("True".lower().replace("false", "")),
